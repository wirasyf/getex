...
class CustomFilterMonth extends StatefulWidget {
  ...
  static Future<FilterMonthResult?> show(
    ...
    return showModalBottomSheet<FilterMonthResult>(
      ...
      backgroundColor: Colors.transparent, // biar blur terlihat
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(top: Radius.circular(16)),
      ),
      transitionAnimationController: AnimationController(
        vsync: Navigator.of(context),
        duration: const Duration(milliseconds: 100), // lebih cepat
          ...
          children: [
            ...
            Positioned.fill(
              child: BackdropFilter(
                ...
                child: Container(
                  color: Colors.black.withOpacity(0), // semi transparan
                ),
              ),
            ),
